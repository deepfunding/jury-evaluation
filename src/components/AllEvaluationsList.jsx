...
export function AllEvaluationsList({ comparisons, onPaginationChange, selectedFilterRepo }) {
  ...
  if (comparisons.length === 0) {
    return <div className="text-sm text-muted-foreground">No evaluations found.</div>;
  }
  ...
  const getComparisonHeader = (comparison) => {
    if (selectedFilterRepo) {
      const otherProject = comparison.itemAName === selectedFilterRepo 
        ? comparison.itemBName 
        : comparison.itemAName;
      
      return (
        <>
          <Badge variant="secondary" className="text-base normal-case font-normal bg-background">
            {selectedFilterRepo}
          </Badge>
    ...
    <div className="space-y-4">
      <div className="flex-1 space-y-3">
        {currentComparisons.map((comparison, index) => {
          const chosenProject = comparison.choice === 1 ? comparison.itemAName : comparison.itemBName;
              ...
              <CardContent className="pt-6 pb-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-sm flex items-center gap-1">
                    ...
                    <span className="text-muted-foreground ml-1">more valuable than</span>
                    <span className="text-primary ml-1">
                      {comparison.choice === 1 ? comparison.itemBName : comparison.itemAName}
                    </span>
                  </div>
