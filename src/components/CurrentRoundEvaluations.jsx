        ...
        <div className="space-y-4">
          <div className="flex-1 space-y-4">
            {currentComparisons.map((comparison, index) => {
              const chosenProject = comparison.choice === 'A' ? comparison.itemAName : comparison.itemBName;
              ...
              const needsExpansion = comparison.reasoning.length > truncatedReasoning.length;
                  ...
                  <CardContent className="py-4">
                    <div className="space-y-3">
                      ...
                      <div className="text-sm">
                        ...
                        <span className="text-muted-foreground ml-1">rated</span>
                        ...
                        <span className="text-primary ml-1">
                          {comparison.choice === 'A' ? comparison.itemBName : comparison.itemAName}
                        </span>
                      </div>

                      <div className="space-y-1">
                        <p className="text-sm text-muted-foreground">
                          "{isExpanded ? comparison.reasoning : truncatedReasoning}"
                        </p>
                        {needsExpansion && (
                          <Button
                            variant="link"
                            className="text-xs p-0 h-auto"
                            onClick={() => setExpandedReasoning(isExpanded ? null : index)}
                          >
